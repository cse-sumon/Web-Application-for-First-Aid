        ...
        <div class="navbar">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="{{URL::to('/dashboard')}}"><span>Doctor First Aid - Admin Panel</span></a>
                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li><a href="{{URL::to('/add-sub-category')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Sub Category</span></a></li>

                            <li><a href="{{URL::to('/manage-sub-category')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Sub Category</span></a></li>

                            <li><a href="{{URL::to('/add-relation')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Relation</span></a></li>

                            <li><a href="{{URL::to('/manage-relation')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Manage Relation</span></a></li>

                            <li><a href="{{URL::to('/add-medicine')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> Add Medicine</span></a></li>

                            <li><a href="{{URL::to('/manage-medicine')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Manage Medicine</span></a></li>

                            <li><a href="{{URL::to('/add-prescription')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Prescription</span></a></li>

                            <li><a href="{{URL::to('/manage-prescription')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Manage Prescription</span></a></li>
