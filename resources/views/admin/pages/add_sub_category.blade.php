...
<!-- start: Content -->
 ...
 <script type="text/javascript">
    ...
    var sub_category_name = document.forms["myForm"]["sub_category_name"].value;
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            ...
            <div class="box-content">
                <form class="form-horizontal"  method="POST" name="myForm" onsubmit="return validateForm();" action="{{URL::to('/save-sub-category')}}">
                            {{ csrf_field() }}
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="sub_category_name"class="span6 typeahead"  > <span style="color: red" id=ersc></span>
                            </div>
                        </div>
                        ...
                        <div class="control-group hidden-phone">
                            ...
                            <div class="controls">
                                <textarea class="cleditor" name="sub_category_description" rows="3"></textarea>
                            </div>
                        </div>
                        <div class="control-group">
